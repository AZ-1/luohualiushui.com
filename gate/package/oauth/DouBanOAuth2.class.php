...
class DouBanOAuth2 {
	...
	public $host = "http://api.douban.com/";  //"https://api.weibo.com/2/";
	/**
	 * Set timeout default.
	 *
	 * @ignore
	 ...
	 * @ignore
	 */
	public $useragent = 'Douban OAuth2 v0.1';
	...
	function authorizeURL() {return 'https://www.douban.com/service/auth2/auth'; }
	...
	function getAccessToken( $type = 'code', $keys ) {
		...
		if ( $type === 'token' ) {
            ...
            $logHandle = new GateLog('error_douban_token', 'normal');
