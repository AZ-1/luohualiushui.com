...
/**
 * PHP SDK for txweibo.com (using OAuth2)
 *
 */

/**
 * 腾讯微博 OAuth 认证类(OAuth2)
 *
 *
 * @package oauth
 * @version 1.0
...
class TX_OAuth {
	 ...
	 * @ignore
	 */
	public $useragent = 'PHP-SDK OAuth2.0';
     ...
     * @return string
     */
	function getAuthorizeURL( $url, $response_type = 'code', $isMobile = TRUE, $wap = false) {
		$params = array();
	...
	function getAccessToken( $type = 'code', $keys ) {
	   ...
	   */
		...
		if ( $type === 'token' ) {
            ...
            $logHandle = new GateLog('error_txweibo', 'normal');
