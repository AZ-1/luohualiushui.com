<?php
namespace Gate\Package\Oauth\Taobao_sdk\Top;

use \Gate\Package\Oauth\Taobao_sdk\Top\Request\UserBuyerGetRequest;
...
class TopClient
{
	...
	protected function curl($url, $postFields = null, $fromMobile = FALSE)
	{
		...
		else
		{
			...
			{
				$logHandle = new GateLog('taobaoAuth', 'normal');
				$str = $reponse . '  httpcode: ' . $httpStatusCode;
	...
	public function execute($request, $session = null)
	{
		...
		{
			$logHandle = new \Gate\Libs\Base\GateLog($this->errorLogFileName, "normal");
