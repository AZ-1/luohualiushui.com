...
Use \Gate\Package\Oauth\Qq_sdk\Lib\SnsNetwork;
Use \Gate\Package\Oauth\Qq_sdk\Lib\SnsSigCheck;
Use \Gate\Package\Oauth\Qq_sdk\Lib\SnsStat;
...
class OpenApiV3
{
	...
	private $server_name = '113.108.20.23';
	private $format = 'json';
	...
	public function api($script_name, $params, $method='post', $protocol='http')
	{
		...
		$logHelper = new \Gate\Libs\Base\GateLog('qzoneApiUrl', 'normal');
		...
		$logHelper->w_log($str);
			...
			$logHelper->w_log("request is done\n");
		}
		return $result_array;
	}
