...
use \Gate\Package\Oauth\WYOAuth AS WYOAuth;
use \Gate\Package\Oauth\WYOAuth2 AS WYOAuth2;
...
class WYClient
{
     ...
     * @return void
     */
    function __construct($akey, $skey, $accecss_token, $accecss_token_secret = null)
    {
        $this->oauth = new WYOAuth2($akey, $skey, $accecss_token, $accecss_token_secret);
    }
	...
	function user_show() {
		return $this->oauth->get('https://api.t.163.com/users/show.json');
	}
    /**
     * 最新关注人微博
     *
