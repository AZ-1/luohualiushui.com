...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/article/upload_pic"             //图片上传提交地址
        ,imagePath:""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置, 返回url是相对路径的时候，配置前缀http://xxxxxx
        ,imageFieldName:"article_pic"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:22800                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,catcherUrl:"/article/download_img"   //处理远程图片抓取的地址
        ,catcherPath:""                  //图片修正地址，同imagePath, 前缀http://xxxxxx
        ,catchFieldName:"content_img_list"                   //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
        //,separater:'ue_separate_ue'               //提交至后台的远程图片地址字符串分隔符
        ,localDomain:["hitao.com"]                            //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地,默认不抓取127.0.0.1和localhost
...
//        }
        ...
        ,initialFrameWidth:925  //初始化编辑器宽度,默认1000
