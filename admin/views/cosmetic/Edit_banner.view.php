<div class="pageContent">
	<form method="post" action="/cosmetic/edit_banner?is_up=1"  class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);" novalidate="novalidate">
		<div class="formBar">
			<ul>
		...
		<div class="pageFormContent" layoutH="50">
			<table>
				...
				<tbody>
						<tr>
						<td><label><?php echo $info?></label>	
						<td><input type="text" name="order" value="<?php echo $order?>">	
						<td><img src=<?php echo $img?> height="70px" width="70px"></label>	
					</tr>
				</tbody>
				<thead>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td><select name="location">
							<option <?php if($location==0) echo "select='seelcted'"?> value="0">大图：滑动显示</ option>
							<option <?php if($location==1) echo "select='seelcted'"?> value="1">小图：列表展示</ option>
						</select></td>
					</tr>
				</tbody>
