<div class="pageContent">
	<form method="post" action="/daren/edit_banner_m" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone)";>
