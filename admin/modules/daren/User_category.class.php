...
class User_category extends \Gate\Libs\Controller {
	...
	public function run() {
		...
		$this->view->userCategoryList = $this->getHotUserCategory();
		$this->page();
	}
	...
	private function page(){
		...
		$page->totalNum = Article::getInstance()->getHotUserCategoryNum($this->name);
		$this->view->page = $page;
	}
	...
	private function getHotUserCategory(){
		...
		return Article::getInstance()->getHotUserCategory($this->name,$offset,$this->length);
	}
}
